        ...
        <div class="bangumi-meta">
            <span class="bangumi-info-items" <%- metaColor ? `style="color:${metaColor};"` : '' %>>
                ...
                <span class="bangumi-info-item bangumi-wish">
                    <span class="bangumi-info-label"><%= __('wantWatch') %></span> <em><%= item.wish %></em>
                </span>
                <span class="bangumi-info-item bangumi-doing">
                    <span class="bangumi-info-label"><%= __('watching') %></span> <em><%= item.doing || "-" %></em>
                </span>
                <span class="bangumi-info-item bangumi-collect">
                    <span class="bangumi-info-label"><%= __('watched') %></span> <em><%= item.collect || "-" %></em>
                </span>
                <span class="bangumi-info-item bangumi-info-item-score">
                    <span class="bangumi-info-label"><%= __('score') %></span> <em><%= item.score || "-" %></em>
                </span>
            </span>
        </div>
